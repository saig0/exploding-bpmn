...
public class SlackUtil {
  ...
  private static final Map<CardType, String> cardEmojis1 =
      Map.of(
          CardType.EXPLODING, ":bpmn-error-throw-event:",
          CardType.DEFUSE, ":bpmn-error-catch-event:",
          CardType.ATTACK, ":bpmn-parallel-gateway:",
          CardType.SEE_THE_FUTURE, ":bpmn-timer-catch-event:",
          CardType.ALTER_THE_FUTURE, ":bpmn-compensation-throw-event:",
          CardType.DRAW_FROM_BOTTOM, ":bpmn-escalation-throw-event:",
          CardType.SHUFFLE, ":bpmn-complex-gateway:",
          CardType.SKIP, ":bpmn-link-throw-event:",
          CardType.NOPE, ":bpmn-cancel-throw-event:",
